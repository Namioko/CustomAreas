...
self = self || __webpack_require__(1);
...
// EXTERNAL MODULE: ./node_modules/paper/dist/paper-full.js
var paper_full = __webpack_require__(0);
...
var CustomArea = function CustomArea(_ref) {
  var _this = this;
  ...
  _defineProperty(this, "initialize", function (_ref2) {
    var handleDelete = _ref2.handleDelete;

    _this.customizeLineToPolygon();

    if (_this.areaSettings.canBeDeleted) {
      _this.addDeleteIcon({
        handleDelete: handleDelete
      });
    }

    _this.polygon.onMouseDrag = _this.handleAreaDrag;
    _this.polygon.onMouseEnter = _this.handleMouseEnter;
    _this.polygon.onMouseLeave = _this.handleMouseLeave;
    _this.polygon.onMouseMove = _this.handleMouseMove;
    _this.polygon.onClick = _this.handleMouseClick;
  });

  _defineProperty(this, "customizeLineToPolygon", function () {
    var startPoint = _this.polygon.segments[0].point;

    _this.polygon.add(new Point(startPoint.x, startPoint.y));

    _this.polygon["class"] = "polygon";
    _this.polygon.fillColor = _this.areaSettings.renderColors.fill;
    _this.polygon.strokeColor = _this.areaSettings.renderColors.stroke;
    _this.polygon.dashArray = [];
  });

  _defineProperty(this, "addDeleteIcon", function (_ref3) {
    ...
    _this.deleteIcon.onClick = function () {
      handleDelete(_this.polygon);

      _this.polygon.remove();

      _this.deleteIcon.remove();
    };
  });

  _defineProperty(this, "handleAreaDrag", function (options) {
    ...
    var elementsToChangePosition = [_this.polygon, _this.deleteIcon];
    elementsToChangePosition.forEach(function (element) {
      if (!element) return;
  ...
  _defineProperty(this, "handleMouseEnter", function () {
    ...
    if (hoverColors) {
      _this.polygon.fillColor = hoverColors.fill;
      _this.polygon.strokeColor = hoverColors.stroke;
    }
  });
  ...
  _defineProperty(this, "handleMouseLeave", function () {
    ...
    if (!_this.state.isSelected) {
      _this.polygon.fillColor = renderColors.fill;
      _this.polygon.strokeColor = renderColors.stroke;
    }
  });

  _defineProperty(this, "handleMouseClick", function () {
    var _this$areaSettings = _this.areaSettings,
        clickColors = _this$areaSettings.clickColors,
        renderColors = _this$areaSettings.renderColors,
        handleMouseClick = _this$areaSettings.handleMouseClick;

    if (clickColors && !_this.state.isSelected) {
      _this.polygon.fillColor = clickColors.fill;
      _this.polygon.strokeColor = clickColors.stroke;
...
// CONCATENATED MODULE: ./src/CustomAreasTool.js
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { CustomAreasTool_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

function CustomAreasTool_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function CustomAreasTool_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }



window.paper = paper_full;

var CustomAreasTool_CustomAreasTool = function CustomAreasTool(_ref) {
  var _this = this;

  var _wrapperId = _ref.wrapperId,
      _imageOptions = _ref.imageOptions;

  CustomAreasTool_classCallCheck(this, CustomAreasTool);

  CustomAreasTool_defineProperty(this, "initialize", function () {
    paper_full["install"](window); // window.addEventListener("contextmenu", (event) => {
    ...
    _this.initializeTool();

    _this.resetHelpObjects();

    var areas = JSON.parse(sessionStorage.getItem("areas")); // this.drawCustomAreas({areasCoordinates: JSON.parse("[[{\"x\":303,\"y\":130},{\"x\":411,\"y\":152},{\"x\":424,\"y\":240},{\"x\":326,\"y\":250},{\"x\":303,\"y\":130}],[{\"x\":529,\"y\":125},{\"x\":611,\"y\":125},{\"x\":641,\"y\":198},{\"x\":551,\"y\":210},{\"x\":529,\"y\":125}],[{\"x\":455,\"y\":290},{\"x\":529,\"y\":280},{\"x\":595,\"y\":336},{\"x\":455,\"y\":396},{\"x\":377,\"y\":348},{\"x\":451,\"y\":293},{\"x\":455,\"y\":290}]]")});

    _this.drawCustomAreas({
      areas: areas
    });
  });

  CustomAreasTool_defineProperty(this, "initializeCanvas", function () {
  ...
  CustomAreasTool_defineProperty(this, "initializeTool", function () {
    var tool = new Tool();
    tool.onMouseDown = _this.handleMouseDown;
  });

  CustomAreasTool_defineProperty(this, "handleMouseDown", function (options) {
    ...
    _this.addPoint(options);
  });

  CustomAreasTool_defineProperty(this, "addPoint", function (options) {
    var x, y;
    ...
    var circle = new Shape.Circle({
      ...
      strokeWidth: 0.5,
      center: [x, y],
      id: _this.pointArray.length + 1,
      "class": "point"
    });

    if (_this.pointArray.length === 0) {
      circle.fillColor = "red";
      circle.onMouseDown = _this.generatePolygonForDesigner;
    }

    _this.activeLine.add(new Point(x, y));
  ...
  CustomAreasTool_defineProperty(this, "generatePolygon", function (_ref2) {
    var area = _ref2.area;

    _this.customAreas.push(new CustomArea({
      polygon: _this.activeLine,
  ...
  CustomAreasTool_defineProperty(this, "saveAreas", function () {
    sessionStorage.setItem("areas", JSON.stringify(_this.customAreas.map(function (area) {
      return _objectSpread(_objectSpread({}, area.areaSettings), {}, {
        coordinates: area.polygon.segments.map(function (segment) {
          return {
            x: segment.point.x,
            y: segment.point.y
          };
  ...
  CustomAreasTool_defineProperty(this, "handleAreaDelete", function (polygon) {
    var polygonIndex = _this.customAreas.findIndex(function (area) {
      return area.polygon.id === polygon.id;
    });
  ...
  CustomAreasTool_defineProperty(this, "drawCustomAreas", function (_ref3) {
    var areas = _ref3.areas;
    areas && areas.forEach(function (area) {
      area.coordinates.forEach(function (pointCoordinates) {
        return _this.addPoint(new Segment(new Point(pointCoordinates)));
      });
